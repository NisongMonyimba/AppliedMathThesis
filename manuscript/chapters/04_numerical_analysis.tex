...
\texttt{simulations/euler\_milstein/run\_convergence\_simulation.py} and a corrected
...
originally contained the same sign error identified and corrected in Appendix~A's
master-equation re-derivation (the $A_t^2/\lambda$ and constant terms had flipped
