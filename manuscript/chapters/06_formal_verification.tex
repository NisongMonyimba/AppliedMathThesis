...
This chapter presents the Lean 4 formalisations of the key mathematical
properties underlying the thesis's central chain of theorems. Formal verification
provides an independent check on mathematical correctness that complements the
numerical validation of Chapters 4 and 5.
