...
\paragraph{Fit} Professor Reppen's work applying neural network and Monte Carlo methods to high
dimensional McKean--Vlasov control problems addresses precisely the curse-of-dimensionality
limitation I identify as an open problem in my own particle-method numerical scheme. I am
especially interested in whether his approach could extend to the common-noise setting, where the
population measure itself is stochastic rather than deterministic.
