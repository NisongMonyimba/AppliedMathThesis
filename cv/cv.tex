...
% Entry header: bold title on the left, date right-aligned inside a
% FIXED-WIDTH box docked to the right margin. This guarantees every
% date's right edge sits at the exact same horizontal column, reading
% top to bottom, regardless of how long the title or date text is, and
% regardless of whether the title wraps to a second line.
\newcommand{\cventry}[2]{%
