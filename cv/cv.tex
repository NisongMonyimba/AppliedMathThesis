...
% Clickable-link "badge": underlined text in a subtle bordered box with a
% light background and a soft drop shadow, so links are visually obvious
% as clickable even when printed or viewed without hover affordances.
\newcommand{\linkbadge}[2]{%
  \tikz[baseline=(X.base)]{\node[draw=blue!50!black, thin, fill=blue!8,
        rounded corners=1.5pt, inner xsep=3pt, inner ysep=1.5pt,
        drop shadow={shadow xshift=0.6pt, shadow yshift=-0.6pt, opacity=0.5}]
        (X) {\href{#1}{\textcolor{blue!55!black}{\underline{#2}}}};}%
}
...
{\footnotesize \cventry{Numerical Approximation of Common-Noise Mean-Field Games via Particle Methods and Finite Differences}{2026}}
\begin{itemize}
