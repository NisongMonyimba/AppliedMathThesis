...
\begin{tabular}{p{1.7cm}p{3.1cm}p{7.8cm}}
\toprule
...
\centering
\small
\caption{Index of numbered results: Chapters 3--7 (main theoretical contributions)}
...
\addlinespace
5 & \textbf{Theorem~\ref{thm:poc}} (Conditional Propagation of Chaos) &
    $\sup_t \mathbb{E}[W_2(\mu_t^N,\mu_t^*)^2 \mid W^0] \le C/N$, uniformly over
    common-noise realisations, with $C$ independent of $N$. \\
\addlinespace
5 & Theorem~\ref{thm:fournier-guillin} (Empirical Measure Rates) & Sharp
    dimension-dependent Wasserstein convergence rates for empirical measures of
    i.i.d.\ samples, underlying the proof of Theorem~5.1. \\
\bottomrule
\end{tabular}
\end{table}

\paragraph{Reading guide.} The results in \textbf{bold} (Theorems 3.1, 4.1, and 5.1)
form the central logical chain of the thesis: well-posedness of the equilibrium
$\to$ convergent numerical approximation $\to$ convergent particle
approximation. Chapter 6 (Scientific Computing) and Chapter 7 (Lean 4 Formal
Verification) support this chain computationally and via partial formal
verification respectively, but do not introduce additional numbered theorems of
the same character; Chapter 8 (Future Directions) is prospective and contains no
numbered results.
