...
\paragraph{Fit} Professor Song's research connecting stochastic control theory to mathematical
finance and engineering applications closely parallels the trajectory of my own work, from
biomedical engineering modeling toward rigorous stochastic control theory. I would welcome the
chance to build on the kind of theory-to-application pipeline his group has demonstrated,
including in stochastic control approaches to financial decision-making under uncertainty.
