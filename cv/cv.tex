...
\noindent Stochastic Analysis \textbullet\ Mean-Field Games \textbullet\ Stochastic Control \textbullet\
Forward--Backward Stochastic Differential Equations \textbullet\ Optimal Transport \textbullet\
Numerical Analysis \textbullet\ Scientific Computing
...
\vspace{2pt}
\noindent \textbf{Graduate Mathematical Preparation (self-directed, 2025--present):} Real Analysis, Functional
Analysis, Measure-Theoretic Probability, Stochastic Calculus, Optimal Control, Mean-Field Games --- undertaken
independently of formal coursework, in connection with the research program below.
...
\cventry{AppliedMathThesis (GitHub)}{}
\begin{itemize}
  \item Reproducible implementations of every numerical experiment reported in the papers above
  \item Mean-field game particle-method solver and Euler--Maruyama/Milstein SDE library (Python)
  ...
  \item Automated test suite (pytest) and continuous integration (GitHub Actions)
...
\noindent \textbf{Mathematical \& Scientific Computing:} Python (NumPy, SciPy, statsmodels, pandas), MATLAB, R, Git/GitHub, LaTeX (Overleaf).\\[3pt]
\textbf{Mathematical Methods:} Monte Carlo simulation, stochastic simulation, finite-difference methods, finite element methods, numerical linear algebra, optimization, statistical modeling (ANOVA, PCA, DOE, SPC).\\[3pt]
