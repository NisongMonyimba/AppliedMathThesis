...
\Cref{cor:lq-riccati} is verified by direct numerical integration of the two
leading Riccati coefficients $(A_t, B_t)$ using two independent solvers -- LSODA
...
within their requested tolerance, confirming the well-posedness claimed in
\Cref{cor:lq-riccati} is not an artefact of a single numerical scheme.
\end{remark}
