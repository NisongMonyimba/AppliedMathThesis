...
\paragraph{Fit} My work is most directly in conversation with Professor Seeger's research on
common-noise mean-field games with degenerate idiosyncratic noise, particularly the weak-solution
framework for backward stochastic Hamilton--Jacobi--Bellman equations developed with Cardaliaguet
and Souganidis. My thesis's contraction estimate assumes non-degenerate idiosyncratic noise
throughout; I am specifically interested in how that argument would need to change in the
degenerate regime his work addresses.
