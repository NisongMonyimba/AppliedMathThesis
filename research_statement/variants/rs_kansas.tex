...
\paragraph{Fit} Professors Duncan and Pasik-Duncan's sustained body of work in stochastic control
theory, and Professor Duncan's editorial experience with SIAM Journal on Control and Optimization,
make KU's mathematics department an ideal environment to build the rigorous foundation my
thesis's contraction and convergence arguments currently lack independent of computational
verification.
