...
This formalises the elementary inequality underlying the contraction factor
$\rho = \sqrt{C_0/(2\lambda - C)} < 1$ of Theorem~3.1.

\begin{lstlisting}[style=lean4, caption={Existence of a contraction factor $\rho < 1$ whenever $\lambda$ is chosen sufficiently large.}]
