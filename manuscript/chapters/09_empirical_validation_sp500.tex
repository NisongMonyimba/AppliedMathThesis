...
returns has a long history. Chen, Hong, and Stein (2002) established that breadth
...
to predict declines in abnormal returns. In the MFG literature, Lehalle and Mouzouni
(2019) calibrated a portfolio trading MFG to 176 US stocks and analysed the
...
costs reported by Frazzini, Israel, and Moskowitz (2018). For robustness, we also
...
pricing documented by Kim, Korajczyk, and Neuhierl (2015), who used the Earth
