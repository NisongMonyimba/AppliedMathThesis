...
\paragraph{Fit} Professor Pang's work in stochastic control, probability, and mathematical finance
overlaps directly with the financial applications developed in my thesis (Chapters 7--9: systemic
risk with optimal bailouts, and a Wasserstein-distance-based alpha-generation framework). I am
drawn to NC State's structured qualifying-exam sequence in measure theory and stochastic processes
as the rigorous foundation I am seeking.
