...
\addlinespace
9 & Empirical validation on S\&P 500 (2000--2024) & Full out-of-sample trading
    strategy; Sharpe 1.91 (conditional on model); incremental over na\"ive 13F;
...
result. Prior to this work, Ahuja, Ren, and Yang (2019) had established existence
and uniqueness for a class of common-noise MFGs with linear-convex structure and
weak-monotonicity, using a continuation method for FBSDEs. Carmona and Delarue
(2018) provided the comprehensive probabilistic characterisation.
...
numerical methods for McKean--Vlasov FBSDEs includes Chassagneux, Crisan, and
Delarue (2019), who established convergence of a particle method for mean-field
...
algorithm. Prior work includes Angiuli, Fouque, Lauri\`ere, and Zhang (2024), who
...
connecting to recent work by Ma, Li, and Zhang (2024). This result serves as an
...
foundational model is due to Carmona, Fouque, and Sun (2015). \textbf{Our
...
Cardaliaguet and Lehalle (2018), and extended to portfolio trading by Lehalle and
Mouzouni (2019). Proposition~\ref{prop:alpha-signals} contributes the four-signal
...
Chapter 9 provided the empirical validation. The use of 13F holdings to predict
returns was established by Chen, Hong, and Stein (2002). Lehalle and Mouzouni
(2019) calibrated a portfolio MFG to 176 stocks. \textbf{Our contribution is a
full out-of-sample trading strategy on the S\&P 500 universe (2000--2024),
achieving a Sharpe ratio of 1.91 (net of costs) with a block-bootstrap $p$-value
of 0.002.} The incremental contribution over a na\"ive 13F mean-reversion strategy
(Sharpe 0.72) and a 13F residual momentum strategy (Sharpe 0.89) is substantial.
Extensive robustness checks confirm stability across specifications. The Sharpe
ratio is conditional on the LQ model specification; model risk is the dominant
...
present six open problems, each contextualised by a survey of recent relevant
...
\paragraph{Recent literature.} A 2024 paper, ``Mean-Field Games with common
Poissonian noise: a Maximum Principle approach'' (arXiv:2401.10952), extends the
...
\subsection{Fully Online Reinforcement Learning with Streaming Data}
...
(e.g., Precup, Sutton, and Singh, 2000; Lange, Gabel, and Riedmiller, 2012)
...
\paragraph{Recent literature.} A 2024 paper in the Journal of Optimization Theory
and Applications, ``Incomplete Information Mean-Field Games and Related Riccati
Equations'', studies a class of MFGs with incomplete information where each
...
dynamics. Additionally, ``Learning in herding Mean Field Games'' (Zeng et al.,
2024) considers agents with differing trade signals.
...
Jaimungal and Nourian, 2015), fixed income (e.g., Carmona and Wang, 2021), and
commodities. In macroeconomics, ``Learning Macroeconomic Policies through Dynamic
Stackelberg Mean-Field Games'' (2025) provides a framework for government policy
design. ``Heterogenous Macro-Finance Model: A Mean-field Game Approach'' (2025)
...
which interpolate between Poincar\'e and log-Sobolev (COLT 2022). ``Taming under
isoperimetry'' (2025) derives Poincar\'e or log-Sobolev inequalities under novel
...
derivation) have been formally verified in Lean 4.
...
\addlinespace
Asymmetric information & Incomplete Information MFG (JOTA, 2024); Zeng et al.\
    (2024) & Nonlinear dynamics, learning with heterogeneous beliefs \\
\addlinespace
Other asset classes / macro & Jaimungal--Nourian (2015); Macro MFG (arXiv, 2025)
    & Data availability, model adaptation \\
\addlinespace
Relaxing LSI & Lata\l a--Oleszkiewicz (COLT 2022); Taming under isoperimetry
    (2025) & Characterising equilibrium measure isoperimetry \\
\addlinespace
...
of interactive theorem provers in mathematical finance. As models become
