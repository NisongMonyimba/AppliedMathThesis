...
(Theorem~\ref{thm:rl-subsequential}). The proof adapts Borkar's (1997, 2008) ordinary
...
rapid progress. Angiuli, Fouque, and Lauriere (2022) introduced a unified
two-timescale RL algorithm for MFGs and mean-field control. Hu and Lauri\`ere (2023)
developed a two-timescale actor-critic method specifically for common-noise MFGs.
Most relevantly, Angiuli, Fouque, Lauri\`ere, and Zhang (2024) proved convergence of a
...
control. The proof structure closely follows that of Angiuli et al. (2024); the novel
...
play algorithms of Perrin et al.\ (2022) and the mean-field actor-critic flow of Zhou,
Zhou, and Hu (2025). \Cref{tab:rl-comparison} situates our contributions relative to
this literature.
...
(Borkar, 2008, Chapter 2). In the LQ-MFG case, this stability can be verified
explicitly (see Appendix~A). For general nonlinear MFGs, it remains an active area
of research; recent work by Zhou, Zhou, and Hu (2025) establishes such stability for
...
The proof adapts Borkar's (1997, 2008) ODE method for two-timescale stochastic
...
approximation (Borkar, 2008, Chapter 2), if $h_\gamma$ is Lipschitz and the ODE
...
property of the BSDE (see El Karoui et al., 1997, or Zhang, 2017, Chapter 4). Under
...
chaos results for interacting particle systems (Carmona and Delarue, 2018, Vol.\ I,
Chapter 1) and the stochastic approximation results for measure-valued processes
(Borkar, 2008, Chapter 7). The contraction property of the MFG map $\Phi$
...
stochastic approximation convergence theorem (Borkar, 2008, Theorem 2.1). A detailed
verification of the conditions of Borkar's theorem for the three-timescale,
...
and policy gradient methods is well established (see, e.g., Ma, Li, and Zhang, 2024).
